...
namespace QuanLyThuVien {
    ...
    public partial class QuanLyThuVienDataSet1 : global::System.Data.DataSet {
        ...
        public partial class TacGiaDataTable : global::System.Data.TypedTableBase<TacGiaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TacGiaRow AddTacGiaRow(string TenTacGia, string SDT) {
...
namespace QuanLyThuVien.QuanLyThuVienDataSet1TableAdapters {
    ...
    public partial class TacGiaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[TacGia] WHERE (([MaTG] = @Original_MaTG) AND ((@IsNull_TenTacG" +
                "ia = 1 AND [TenTacGia] IS NULL) OR ([TenTacGia] = @Original_TenTacGia)) AND ((@I" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[TacGia] ([TenTacGia], [SDT]) VALUES (@TenTacGia, @SDT);\r\nSELEC" +
                "T MaTG, TenTacGia, SDT FROM TacGia WHERE (MaTG = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[TacGia] SET [TenTacGia] = @TenTacGia, [SDT] = @SDT WHERE (([MaTG] = @Original_MaTG) AND ((@IsNull_TenTacGia = 1 AND [TenTacGia] IS NULL) OR ([TenTacGia] = @Original_TenTacGia)) AND ((@IsNull_SDT = 1 AND [SDT] IS NULL) OR ([SDT] = @Original_SDT)));
SELECT MaTG, TenTacGia, SDT FROM TacGia WHERE (MaTG = @MaTG)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaTG, TenTacGia, SDT FROM dbo.TacGia";
        ...
        public virtual int Delete(int Original_MaTG, string Original_TenTacGia, string Original_SDT) {
        ...
        public virtual int Insert(string TenTacGia, string SDT) {
            if ((TenTacGia == null)) {
        ...
        public virtual int Update(string TenTacGia, string SDT, int Original_MaTG, string Original_TenTacGia, string Original_SDT, int MaTG) {
            if ((TenTacGia == null)) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(MaTG));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string TenTacGia, string SDT, int Original_MaTG, string Original_TenTacGia, string Original_SDT) {
            return this.Update(TenTacGia, SDT, Original_MaTG, Original_TenTacGia, Original_SDT, Original_MaTG);
        }
    }
